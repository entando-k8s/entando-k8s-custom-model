...
public abstract class AbstractEntandoAppPluginLinkTest implements CustomResourceTestUtil {
    ...
    void testCreateEntandoAppPluginLink() {
        ...
        EntandoAppPluginLink entandoAppPluginLink = new EntandoAppPluginLinkBuilder()
                ...
                .endSpec()
                .build();
        entandoAppPluginLinks().inNamespace(MY_APP_NAMESPACE)
    ...
    void testEditEntandoAppPluginLink() {
        ...
        EntandoAppPluginLink actual = entandoAppPluginLinks().inNamespace(MY_APP_NAMESPACE).withName(MY_APP_PLUGIN_LINK)
                .patch(new EntandoAppPluginLinkBuilder(
                        entandoAppPluginLinks().inNamespace(MY_APP_NAMESPACE).withName(MY_APP_PLUGIN_LINK).fromServer().get())
    ...
    protected MixedOperation<EntandoAppPluginLink, KubernetesResourceList<EntandoAppPluginLink>, Resource<EntandoAppPluginLink>> entandoAppPluginLinks() {
        return getClient().customResources(EntandoAppPluginLink.class);
